...
class TopicMessageQuery {
  ...
  setErrorHandler(errorHandler) {
    this._errorHandler = errorHandler instanceof _TopicMessage.default ? errorHandler : errorHandler;
    return this;
  }
  /**
   * @param {Client<*>} client
  ...
  subscribe(client, errorHandler, listener) {
    ...
    this._makeServerStreamRequest(handle, 0, client, errorHandler, listener);
    ...
    const cancel = client._mirrorNetwork.getNextMirrorNode().channel.makeServerStreamRequest(request, (error, data) => {
      if (data == null || error != null) {
        ...
        if (attempt < 10 && (error === 5 || error === 14)) {
          setTimeout(() => {
            this._makeServerStreamRequest(handle, attempt + 1, client, errorHandler, listener);
          }, 250 * 2 ** attempt);
        } //  else {
      ...
      if (message.chunkInfo == null) {
        const topicMessage = _TopicMessage.default._ofSingle(message);
