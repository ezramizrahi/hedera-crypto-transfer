...
export default class TopicMessageQuery {
    ...
    _errorHandler: ((message: TopicMessage, error: Error) => void) | undefined;
    /**
     * @param {Client<*>} client
     * @param {(message: TopicMessage, error: Error)=> void} errorHandler
     ...
     */
    subscribe(client: import("../client/Client.js").default<any, import("../channel/MirrorChannel.js").default>, errorHandler: (message: TopicMessage, error: Error) => void, listener: (message: TopicMessage) => void): SubscriptionHandle;
    /**
     ...
     * @returns {void}
     */
    _makeServerStreamRequest(handle: SubscriptionHandle, attempt: number, client: import("../client/Client.js").default<Channel, MirrorChannel>, errorHandler: (message: TopicMessage, error: Error) => void, listener: (message: TopicMessage) => void): void;
}
 ...
 */
export type Client<ChannelT extends import("../channel/Channel.js").default> = import("../client/Client.js").default<ChannelT, import("../channel/MirrorChannel.js").default>;
