...
export default class LiveHashQuery extends Query<LiveHash> {
     ...
     */
    protected _getMethod(channel: Channel): (query: proto.IQuery) => Promise<proto.IResponse>;
}
export namespace proto {
    ...
    type ICryptoGetLiveHashQuery = import("@hashgraph/proto/lib/proto").proto.ICryptoGetLiveHashQuery;
    type ICryptoGetLiveHashResponse = import("@hashgraph/proto/lib/proto").proto.ICryptoGetLiveHashResponse;
    type ILiveHash = import("@hashgraph/proto/lib/proto").proto.ILiveHash;
}
