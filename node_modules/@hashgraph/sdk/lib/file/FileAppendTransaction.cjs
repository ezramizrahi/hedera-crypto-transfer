...
class FileAppendTransaction extends _Transaction.default {
  ...
  freezeWith(client) {
    ...
    for (let chunk = 0; chunk < chunks; chunk++) {
      ...
      nextTransactionId = new _TransactionId.default(nextTransactionId.accountId, new _Timestamp.default(nextTransactionId.validStart.seconds, nextTransactionId.validStart.nanos.add(1)));
