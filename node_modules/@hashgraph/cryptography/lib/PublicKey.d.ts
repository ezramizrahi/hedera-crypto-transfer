...
export type Transaction = {
    _isFrozen: () => boolean;
    _signedTransactions: import("./PrivateKey.js").ProtoSignedTransaction[];
    _signerPublicKeys: Set<string>;
    addSignature: (publicKey: PublicKey, signature: Uint8Array) => import("./PrivateKey.js").Transaction;
    _requireFrozen: () => void;
    freeze: () => import("./PrivateKey.js").Transaction;
};
